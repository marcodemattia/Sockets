...
#ifndef SOCKETS_MULTICASTSERVERWITHPOLL_H
#define SOCKETS_MULTICASTSERVERWITHPOLL_H
...
{
 public:
  MulticastServerWithPoll(const char * PORT, const char * UDP_PORT);
  void loop();
...
#endif //SOCKETS_MULTICASTSERVERWITHPOLL_H
